void avanzar(){
  ...
  ultraSonido();                                                // se llama a ñla funcion ultrasonido para saber si hay algo adelante o no 
  Serial.print(distancia);
  encoders();                                                   // se inicializan los encoders 
   //Serial.print(distancia);
  while(distanciaEncoders < distanciaRecorrida){                // se haci un bucle hasta que se termina de completar la distancia total recorida
